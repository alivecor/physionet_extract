...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Extract data from nsrdb', allow_abbrev=True)
    parser.add_argument('--path','-p', type=str, help='base path for file read/write (nsrdb will be appended)')
    args = parser.parse_args()
    if args.path==None:
        args.path = os.getcwd()

    code_path = nsrdb_codepath
